...
4. **Detección Automática de Anomalías:** Identificación de las frecuencias dominantes mediante un buscador de picos nativo. El algoritmo aplica un filtro de paso alto (> 65.0 Hz) para evadir el ruido estructural y rotacional, evaluando el Top 20 de picos de mayor energía contra la cinemática teórica del rodamiento (BPFI, BPFO, BSF) con un margen de tolerancia estricto.
...
* `anomaly_detector.py`: Algoritmo detector de máximos locales e identificador de anomalías mediante ranking de energía (Top 20).
...
4. Espectro de Envolvente Óptimo, donde el pico dominante se alinea perfectamente con la línea teórica del tipo de fallo detectado.